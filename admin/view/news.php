		...
		<section class="content">
			...
			<div class="wraper container-fluid">
                <div class="page-title">
                    <h3 class="title"><i class="fa fa-newspaper-o"></i> Новости</h3>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body p-t-0">
                            	<div class="col-md-5">
                                 ...
                                 <div class="col-md-7">
                                 	<!-- <a href="?act=new-news" class="btn btn-info pull-right"><i class="fa  fa-plus"></i> Добавить</a> -->
                        ...
                        <div class="modal-content">
                            <form action="" method="POST">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="full-width-modalLabel">Новая новость</h4>
                                </div>
